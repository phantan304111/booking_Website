...
//   const navigate = useNavigate();
//  const df = new DecimalFormalt('#,##0');
//  df.setRoundingMode(RoundingMode.HALF_EVEN);
//  const dispatch = useDispatch();
//  const quatity = useSelector(state => state.cart.products)
//  const products = localStorage.getItem('arrProducts')? SaveFormLocalStorage('arrProducts'): null;
//  const numberOfCartItems =!!products&&products.reduce((curNumber, item)=>{
//    return curNumber + item.total;
//  },0 );
//  const handleCheckOut =()=>{
//    navigate('/checkout',{replace:true})
